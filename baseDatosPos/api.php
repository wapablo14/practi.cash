...
//parametros para la funcion Suscribir nuevo numero
$accion_suscribir = $_POST['a_suscribir']; 
$numero_suscribir = $_POST['numero'];
$clave_suscribir = $_POST['clave'];
$fecha_entrada = $_POST['fecha_entrada'];


//parametros para el saldo
$accion_saldo = $_POST['a_saldo']; 
$telefono_saldo=$_POST['telefono'];
$key_saldo = $_POST['key'];


//parametros para la transaccion
$accion_transaccion = $_POST['a_transaccion'];
$telefono_transaccion = $_POST['telefono_transaccion'];
$key_transaccion = $_POST['key_transaccion'];


//parametros para la tarjeta de credito
$accion_tarjeta=$_POST['a_tarjeta'];
$telefono_cliente_tarjeta =$_POST['telefono_cliente_tarjeta'];
$key_tarjeta= $_POST['key_tarjeta'];


//parametros para el perfil
$accion_perfil=$_POST['a_perfil'];;
...
$accion_pago = $_POST['pago'];
$id_cliente_pa_paga = $_POST['id_cliente_paga'];
$id_cliente_pa_recibe = $_POST['id_cliente_recibe'];
$cantidad = $_POST['cantidad_a_pagar'];



//************************************funcion para la SUSCRIPCION DE NUEVO NUMERO

/*
$accion_suscribir = "a_suscribir";
$numero_suscribir = "9876";
$clave_suscribir = "4567";
*/

if($accion_suscribir=="a_suscribir" && $numero_suscribir !="" && $clave_suscribir!="")
{
...
elseif($accion_saldo!="" && $accion_saldo=="verSaldo" && $telefono_saldo!="" && $key_saldo!="")
{
...
elseif($accion_transaccion=="consultar" && $telefono_transaccion!="" && $key_transaccion!="") 
{
...
$key_tarjeta= "123";
*/
elseif($accion_tarjeta=="accionTarjeta" && $telefono_cliente_tarjeta!="" && $key_tarjeta!="")
{
...
$key_perfil= "123";
*/
elseif($accion_perfil=="accionPerfil" && $telefono_cliente_perfil!="" && $key_perfil!="")
{
...
*/
elseif($accion_pago="pagar" && $telefono_paga!="" && $key_pagar!="" && $valor_de_pago!="" && $telefono_recibe !="")
{
...
//aqui se inserta el registro de recibe dinero
	...
	$sql_cliente_recibe = "INSERT INTO transacciones(fecha,id_cliente,valor,descripcion,observacion,id_tarjeta, stripe_id,transaccion_id) VALUES('$fecha_recibe','$id_cli_re','$valor_de_pago','$descripcion_cli_re','$observacion_cli_re','$id_tarjeta_recibe','$stripe_id','valor_temporal') 
";

	$resultado_insertar_recibe=pg_query($cone,$sql_cliente_recibe);

//aqui se obtiene el id despues de recibir el pago
	$sql_id_recibe = "SELECT tra.id FROM transacciones tra WHERE tra.fecha = '$fecha_recibe' AND tra.id_cliente = '$id_cli_re'";
...
//aqui se inserta el registro de pagar dinero
	...
	$sql_cliente_paga = "INSERT INTO transacciones(fecha,id_cliente,valor,descripcion,observacion,id_tarjeta, stripe_id,transaccion_id) VALUES('$fecha_paga','$id_cli_pa','-$valor_de_pago','$descripcion_cli_pa','$observacion_cli_pa','$id_tarjeta_paga','$stripe_id_paga','valor_temporal') 
";
...
//aqui se obtiene el id despues de registrar el pago
	...
	$sql_id_pago = "SELECT tra.id FROM transacciones tra WHERE tra.fecha = '$fecha_paga' AND tra.id_cliente = '$id_cli_pa'";
